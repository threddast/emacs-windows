...
(fn MODES &rest BACKENDS)" nil nil) (function-put 'set-company-backend! 'lisp-indent-function 'defun))(put 'set-company-backend! 'doom-module '(:completion . company))(autoload '+vertico:project-search "~/.emacs.d/modules/completion/vertico/autoload/evil" nil t)(autoload '+vertico:project-search-from-cwd "~/.emacs.d/modules/completion/vertico/autoload/evil" nil t)(autoload '+vertico/embark-magit-status "c:/Users/threddast/.emacs.d/modules/completion/vertico/autoload/magit" "Run `magit-status` on repo containing the embark target.

(fn FILE)" t nil)(defvar embark-quit-after-action)(autoload '+vertico-file-search "c:/Users/threddast/.emacs.d/modules/completion/vertico/autoload/vertico" "Conduct a file search using ripgrep.
...
(fn URL &optional NEW-SESSION)" nil nil)(register-definition-prefixes "c:/Users/threddast/.emacs.d/modules/tools/lookup/autoload/xwidget" '("+lookup--xwidget-webkit-last-session-buffer"))(register-definition-prefixes "c:/Users/threddast/.emacs.d/modules/tools/lsp/autoload/common" '("lsp!"))(autoload 'lsp! "c:/Users/threddast/.emacs.d/modules/tools/lsp/autoload/common.el" "Dispatch to call the currently used lsp client entrypoint" t nil)(put 'lsp! 'doom-module '(:tools . lsp))(defmacro set-eglot-client! (mode server-call) "THIS FUNCTION DOES NOTHING BECAUSE (:tools . lsp) IS DISABLED

Add SERVER-CALL list as a possible lsp server for given major MODE.

Example : (set-eglot-client! 'python-mode `(,(concat doom-data-dir \"lsp/mspyls/Microsoft.Python.LanguageServer\")))" (ignore mode server-call))(put 'set-eglot-client! 'doom-module '(:tools . lsp))(register-definition-prefixes "c:/Users/threddast/.emacs.d/modules/tools/lsp/autoload/flycheck-eglot" '("+lsp--flycheck-eglot-"))(autoload '+lsp/uninstall-server "c:/Users/threddast/.emacs.d/modules/tools/lsp/autoload/lsp-mode" "Delete a LSP server from `lsp-server-install-dir'.

(fn DIR)" t nil)(autoload '+lsp/switch-client "c:/Users/threddast/.emacs.d/modules/tools/lsp/autoload/lsp-mode" "Switch to another LSP server.

(fn CLIENT)" t nil)(autoload '+lsp-lookup-definition-handler "c:/Users/threddast/.emacs.d/modules/tools/lsp/autoload/lsp-mode" "Find definition of the symbol at point using LSP." t nil)(autoload '+lsp-lookup-references-handler "c:/Users/threddast/.emacs.d/modules/tools/lsp/autoload/lsp-mode" "Find project-wide references of the symbol at point using LSP.

(fn &optional INCLUDE-DECLARATION)" t nil)(register-definition-prefixes "c:/Users/threddast/.emacs.d/modules/tools/lsp/autoload/lsp-mode" '("set-lsp-priority!"))(autoload 'set-lsp-priority! "c:/Users/threddast/.emacs.d/modules/tools/lsp/autoload/lsp-mode.el" "Change the PRIORITY of lsp CLIENT.

(fn CLIENT PRIORITY)" nil nil)(put 'set-lsp-priority! 'doom-module '(:tools . lsp))(defadvice! +magit--ignore-version-a (fn &rest args) :around #'magit-version (let ((inhibit-message (not (called-interactively-p 'any)))) (apply fn args)))(autoload '+magit-display-buffer-fn "c:/Users/threddast/.emacs.d/modules/tools/magit/autoload" "Same as `magit-display-buffer-traditional', except...

- If opened from a commit window, it will open below it.
- Magit process windows are always opened in small windows below the current.
- Everything else will reuse the same window.

(fn BUFFER)" nil nil)(autoload '+magit-mark-stale-buffers-h "c:/Users/threddast/.emacs.d/modules/tools/magit/autoload" "Revert all visible buffers and mark buried buffers as stale.

Stale buffers are reverted when they are switched to, assuming they haven't been
modified." nil nil)(autoload '+magit-revert-buffer-maybe-h "c:/Users/threddast/.emacs.d/modules/tools/magit/autoload" "Update `vc' and `git-gutter' if out of date." nil nil)(autoload '+magit/quit "c:/Users/threddast/.emacs.d/modules/tools/magit/autoload" "Bury the current magit buffer.
...
(fn &optional KILL-BUFFER)" t nil)(autoload '+magit/quit-all "c:/Users/threddast/.emacs.d/modules/tools/magit/autoload" "Kill all magit buffers for the current repository." t nil)(autoload '+magit/start-code-review "c:/Users/threddast/.emacs.d/modules/tools/magit/autoload" "

(fn ARG)" t nil)(register-definition-prefixes "c:/Users/threddast/.emacs.d/modules/tools/magit/autoload" '("+magit--"))(fset 'tree-sitter! #'ignore)(autoload '+doom-dashboard/open "c:/Users/threddast/.emacs.d/modules/ui/doom-dashboard/autoload" "Switch to the dashboard in the current window, of the current FRAME.
...
(fn &optional ARG)" t nil)(register-definition-prefixes "dired-async" '("dired-async-"))(register-definition-prefixes "smtpmail-async" '("async-smtpmail-"))(autoload 'code-review-forge-pr-at-point "code-review" "Review the forge pull request at point.
OUTDATED." t nil)(autoload 'code-review-start "code-review" "Start review given PR URL.

(fn URL)" t nil)(register-definition-prefixes "code-review" '("code-review-"))(autoload 'code-review--submit "code-review-actions" "Submit your review with a final verdict (EVENT).
...
(fn &rest _)" t nil)(autoload 'code-review-toggle-display-all-comments "code-review-actions" "Toggle display comments." t nil)(autoload 'code-review-toggle-display-top-level-comments "code-review-actions" "Toggle display the top level comments." t nil)(autoload 'code-review-toggle-display-diff-comments "code-review-actions" "Toggle display the top level comments." t nil)(autoload 'code-review-comment-code-suggestion "code-review-actions" "Add code suggestion box." t nil)(autoload 'code-review-comment-jump-next "code-review-actions" "Go to next comment in the buffer." t nil)(autoload 'code-review-comment-jump-previous "code-review-actions" "Go to previous comment in the buffer." t nil)(register-definition-prefixes "code-review-actions" '("code-review-"))(register-definition-prefixes "code-review-bitbucket" '("code-review-"))(autoload 'code-review-comment-add-or-edit "code-review-comment" "Add or edit comment depending on context.
Inform if a SUGGESTION-CODE? is being proposed.

(fn &optional SUGGESTION-CODE\\=\\?)" t nil)(autoload 'code-review-comment-commit "code-review-comment" "Commit comment." t nil)(autoload 'code-review-input-mention-user-at-point "code-review-comment" "Insert @USERNAME at current point to mention an user." t nil)(autoload 'code-review-comment-quit "code-review-comment" "Quit the comment window." t nil)(register-definition-prefixes "code-review-comment" '("code-review-"))(register-definition-prefixes "code-review-db" '("code-review-"))(register-definition-prefixes "code-review-github" '("code-review-"))(register-definition-prefixes "code-review-gitlab" '("code-review-"))(register-definition-prefixes "code-review-parse-hunk" '("code-review-parse-"))(autoload 'code-review-section-delete-comment "code-review-section" "Delete a local comment." t nil)(register-definition-prefixes "code-review-section" '("code-review-"))(register-definition-prefixes "code-review-utils" '("code-review-"))(register-definition-prefixes "closql" '("closql-" "eieio-"))(register-definition-prefixes "a" '("a-"))(register-definition-prefixes "buck" '("buck-default-host"))(autoload 'ghub-clear-caches "ghub" "Clear all caches that might negatively affect Ghub.
...
(fn TIME-BASED)" t nil)(register-definition-prefixes "uuidgen" '("uuidgen-"))(register-definition-prefixes "deferred" '("deferred:"))(autoload 'markdown-mode "markdown-mode" "Major mode for editing Markdown files.
...
(fn &optional ARG)" t nil)(register-definition-prefixes "markdown-mode" '("defun-markdown-" "gfm-" "markdown"))(defvar forge-add-default-bindings t "Whether to add Forge's bindings to various Magit keymaps.
...
This respects the `emojify-emoji-styles' variable." t nil)(register-definition-prefixes "emojify" '("emojify-"))(register-definition-prefixes "ht" 'nil)(autoload 'highlight-quoted-mode "highlight-quoted" "Highlight Lisp quotes and quoted symbols.
...
(fn &optional ARG)" t nil)(register-definition-prefixes "evil-org-agenda" '("evil-org-agenda-"))(with-eval-after-load 'magit (define-key magit-mode-map [remap org-store-link] #'orgit-store-link))(autoload 'orgit-store-link "orgit" "Like `org-store-link' but store links to all selected commits, if any.
...
(fn &optional ARG)" t nil)(register-definition-prefixes "ace-window" '("ace-window-mode" "aw-"))(autoload 'pfuture-new "pfuture" "Create a new future process for command CMD.
...
(fn &rest CMD)" nil nil)(register-definition-prefixes "pfuture" '("pfuture-"))(autoload 'defhydra "hydra" "Create a Hydra - a family of functions with prefix NAME.
...
(fn &optional ARG)" t nil)(register-definition-prefixes "treemacs-projectile" '("treemacs-"))(register-definition-prefixes "treemacs-magit" '("treemacs-magit--"))(autoload 'lsp-treemacs-symbols "lsp-treemacs" "Show symbols view." t nil)(autoload 'lsp-treemacs-java-deps-list "lsp-treemacs" "Display java dependencies." t nil)(autoload 'lsp-treemacs-java-deps-follow "lsp-treemacs" nil t nil)(defvar lsp-treemacs-sync-mode nil "Non-nil if Lsp-Treemacs-Sync mode is enabled.
...
(fn &optional TYPE-OR-OBJECT FPS DELAY)" nil nil)(register-definition-prefixes "spinner" '("spinner-"))(autoload 'format-all-buffer "format-all" "Auto-format the source code in the current buffer.
...
(fn &optional ARG)" t nil)(register-definition-prefixes "writegood-mode" '("writegood-"))(autoload 'lsp-ui-mode "lsp-ui" "Toggle language server UI mode on or off.
...
(fn GROUP-RESULTS)" t nil)(register-definition-prefixes "consult-lsp" '("consult-lsp-"))(autoload 'pdf-annot-minor-mode "pdf-annot" "Support for PDF Annotations.
...
buffer and returned as a string in Org format." t nil)(register-definition-prefixes "ox-hugo" '("org-hugo-"))(register-definition-prefixes "ox-hugo-deprecated" '("org-hugo-"))(register-definition-prefixes "ox-hugo-pandoc-cite" '("org-hugo-pandoc-cite-"))(register-definition-prefixes "tomelr" '("tomelr-"))(autoload 'org-timeline-insert-timeline "org-timeline" "Insert graphical timeline into agenda buffer." nil nil)(register-definition-prefixes "org-timeline" '("org-timeline-"))(autoload 'org-modern-mode "org-modern" "Modern looks for Org.
...
(fn &optional ARG)" t nil)(register-definition-prefixes "org-auto-tangle" '("org-auto-tangle-"))(autoload 'lorem-ipsum-use-default-bindings "lorem-ipsum" "Use the default keybindings of C-c l [spl]." t nil)(autoload 'lorem-ipsum-insert-paragraphs "lorem-ipsum" "Insert lorem ipsum paragraphs into buffer.
If NUM is non-nil, insert NUM paragraphs.

(fn &optional NUM)" t nil)(defalias 'Lorem-ipsum-insert-paragraphs 'lorem-ipsum-insert-paragraphs)(autoload 'lorem-ipsum-insert-sentences "lorem-ipsum" "Insert lorem ipsum sentences into buffer.
If NUM is non-nil, insert NUM sentences.

(fn &optional NUM)" t nil)(defalias 'Lorem-ipsum-insert-sentences 'lorem-ipsum-insert-sentences)(autoload 'lorem-ipsum-insert-list "lorem-ipsum" "Insert lorem ipsum list items into buffer.
If NUM is non-nil, insert NUM list items.

(fn &optional NUM)" t nil)(defalias 'Lorem-ipsum-insert-list 'lorem-ipsum-insert-list)(register-definition-prefixes "lorem-ipsum" '("lorem-ipsum-"))(autoload 'org-present "org-present" "Start org presentation." t nil)(register-definition-prefixes "org-present" '("org-present-"))(autoload 'org-tree-slide-mode "org-tree-slide" "A presentation tool for org-mode.
...
(fn &optional ARG)" t nil)(register-definition-prefixes "centered-window" '("cwm-"))(autoload 'math-at-point-simple "math-at-point" "Evaluate the simple math expression at point with `calc-eval'.
...
(fn &optional INSERT)" t nil)(autoload 'math-at-point "math-at-point" "Evaluate the math expression at point with `calc-eval'.
...
(fn &optional INSERT)" t nil)(autoload 'math-at-point-expression "math-at-point" "Evaluate the math expression at point with `calc-eval'.
...
(fn &optional INSERT)" t nil)(autoload 'math-at-point-latex "math-at-point" "Evaluate the LaTeX math expression at point with `calc-eval'.
...
(fn &optional INSERT PARAMS)" t nil)(register-definition-prefixes "math-at-point" '("map-"))(defvar selectric-mode nil "Non-nil if Selectric mode is enabled.
See the `selectric-mode' command
for a description of this minor mode.
Setting this variable directly does not take effect;
either customize it (see the info node `Easy Customization')
or call the function `selectric-mode'.")(autoload 'selectric-mode "selectric-mode" "Toggle Selectric mode.
...
(fn &optional ARG)" t nil)(register-definition-prefixes "selectric-mode" '("selectric-"))(autoload 'xkcd-mode "xkcd" "Major mode for viewing xkcd (https://xkcd.com/) comics.

(fn)" t nil)(autoload 'xkcd-get "xkcd" "Get the xkcd number NUM.

(fn NUM)" t nil)(autoload 'xkcd-get-latest "xkcd" "Get the latest xkcd." t nil)(defalias 'xkcd 'xkcd-get-latest)(register-definition-prefixes "xkcd" '("get-xkcd-from-url" "xkcd-"))(autoload 'org-ql-select "org-ql" "Return items matching QUERY in BUFFERS-OR-FILES.
...
(fn &key (SELECT \\='element-with-markers) FROM WHERE NARROW ORDER-BY)" nil nil)(function-put 'org-ql-query 'lisp-indent-function '0)(register-definition-prefixes "org-ql" '("org-ql-"))(autoload 'org-ql-completing-read "org-ql-completing-read" "Return marker at Org entry in BUFFERS-FILES selected with `org-ql'.
...
(fn BUFFERS-FILES &key QUERY-PREFIX QUERY-FILTER (PROMPT \"Find entry: \"))" t nil)(autoload 'org-ql-refile "org-ql-find" "Refile current entry to MARKER (interactively, one selected with `org-ql').
Interactive completion uses files listed in `org-refile-targets',
which see (but only the files are used).

(fn MARKER)" t nil)(autoload 'org-ql-find-in-agenda "org-ql-find" "Call `org-ql-find' on `org-agenda-files'." t nil)(autoload 'org-ql-find-in-org-directory "org-ql-find" "Call `org-ql-find' on files in `org-directory'." t nil)(register-definition-prefixes "org-ql-find" '("org-ql-find-goto-hook"))(autoload 'org-ql-sparse-tree "org-ql-search" "Show a sparse tree for QUERY in BUFFER and return number of results.
...
(fn QUERY)" nil nil)(defalias 'org-ql-block 'org-ql-search-block)(register-definition-prefixes "org-ql-search" '("org-ql-"))(autoload 'org-ql-view "org-ql-view" "Choose and display the `org-ql-views' view NAME.
...
(fn BOOKMARK)" nil nil)(register-definition-prefixes "org-ql-view" '("org-ql-view"))(defvar org-super-agenda-mode nil "Non-nil if Org-Super-Agenda mode is enabled.
...
(fn &optional ARG)" t nil)(register-definition-prefixes "org-super-agenda" '("org-super-agenda-"))(register-definition-prefixes "ts" '("ts-" "ts<" "ts=" "ts>"))(autoload 'ov-clear "ov" "Clear overlays satisfying a condition.
...
(fn &optional PROP-OR-BEG (VAL-OR-END \\='any) BEG END)" t nil)(register-definition-prefixes "ov" 'nil)(register-definition-prefixes "peg" '("bob" "bol" "bos" "bow" "define-peg-rule" "eob" "eol" "eos" "eow" "fail" "null" "peg" "with-peg-rules"))(register-definition-prefixes "peg-tests" '("peg-"))(autoload 'org-sidebar "org-sidebar" "Display the Org Sidebar.
...
(fn FNS)" t nil)(autoload 'org-sidebar-toggle "org-sidebar" "Toggle default sidebar window.
If it is open and shows the view for the current buffer, delete
it.  Otherwise, show it for current buffer." t nil)(autoload 'org-sidebar-ql "org-sidebar" "Display a sidebar for `org-ql' QUERY.
...
(fn BUFFERS-FILES QUERY &key NARROW SUPER-GROUPS SORT TITLE)" t nil)(function-put 'org-sidebar-ql 'lisp-indent-function 'defun)(autoload 'org-sidebar-backlinks "org-sidebar" "Show sidebar with entries that link to the current entry.
...
properties." t nil)(autoload 'org-sidebar-tree "org-sidebar" "Show tree-view sidebar." t nil)(autoload 'org-sidebar-tree-toggle "org-sidebar" "Toggle tree-view sidebar window.
If it is open and shows the view for the current buffer, delete
it.  Otherwise, show it for current buffer." t nil)(autoload 'org-sidebar-tree-view-buffer "org-sidebar" "Return a tree-view buffer for BUFFER.

(fn &key (BUFFER (current-buffer)) &allow-other-keys)" nil nil)(register-definition-prefixes "org-sidebar" '("org-"))(register-definition-prefixes "org-noter-pdftools" '("org-noter-pdftools-"))